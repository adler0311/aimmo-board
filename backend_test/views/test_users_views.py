...
def test_get_contents_token_required(mock_get_auth_token, client, invalid_token_header):
...
def test_get_contents_type_parameter_invalid(mock_get_auth_token, client, valid_token, valid_token_header):
    ...
    response = client.get('/users/posts?type=board',
...
@mock.patch("backend.views.decorators.AuthService.get_auth_token")
@mock.patch("backend.views.users_view.UserService.get_posts")
...
@mock.patch("backend.views.decorators.AuthService.get_auth_token")
@mock.patch("backend.views.users_view.UserService.get_liked_posts")
...
@mock.patch("backend.views.decorators.AuthService.get_auth_token")
@mock.patch("backend.views.users_view.UserService.get_comments")
